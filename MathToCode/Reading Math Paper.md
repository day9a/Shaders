...
|                                                <br><font color="#00b050">Factorial of a number n<br></font> [[#Factorial]]                                                |                       $n! = \prod_{k=1}^{n} k = 1 \cdot 2 \cdot 3 \dots n$                        |                                                   `int result = 1;` <br>`for (int i=2; i<=n; i++) {result *= i; }`<br><br><font color="#7f7f7f">5!=1⋅2⋅3⋅4⋅5=120</font>                                                    |
...
|                                                          <br><font color="#00b050">Piecewise function</font><br>                                                          |                          $$ f(x) = \begin{cases} a, & x < 0 \\ b, & x \ge 0 \end{cases} $$                           |                                                                                               <br>`mix(a, b, step(0.0, x))`                                                                                                |
