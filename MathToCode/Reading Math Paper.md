#math #physics #vector #matrix #equation #logic 

[MathJax cheatsheet](https://easy-copy-mathjax.nakaken88.com/en/all/)
...
|                                                              <br><font color="#00b050">2x2 Matrix</font><br>                                                              |                                   <br>$\begin{bmatrix}a & b \\c & d\end{bmatrix}$                                    |                                                                       <br>`mat2(a, c, b, d);` <br><font color="#7f7f7f">GLSL is column-major</font>                                                                        |                      |                                                |
...
|                                                <br><font color="#00b050">Factorial of a number n<br></font> [[#Factorial]]                                                |                            $$ n! = \prod_{k=1}^{n} k = 1\cdot2\cdot3\cdot \cdot \cdot n$$                            |                                                   `int result = 1;` <br>`for (int i=2; i<=n; i++) {result *= i; }`<br><br><font color="#7f7f7f">5!=1⋅2⋅3⋅4⋅5=120</font>                                                    |                      |                                                |
|                                                <br><font color="#00b050">Sum of elements<br>(Sigma)</font><br>[[#Sigma ∑]]                                                |                                               <br>$\sum_{i=0}^{n} x_i$                                               |                                               `for(int i=0; i<=n; ++i) { sum += x[i]; }`<br><br><font color="#7f7f7f">A `for` loop where we add values to a variable</font>                                                |                      |                                                |
|                                          <font color="#00b050">Derivative (Gradient) <br>(Nabla)</font><br>[[#Derivative ∇]]<br>                                          |                                                 <br>$\nabla f(x, y)$                                                 |                                                                                             <br>`vec2(f(x+e,y)-f(x-e,y), ...)`                                                                                             |                      |                                                |
|                                                       <font color="#00b050">Integral</font><br>[[#Integral ∫]]<br>                                                        |                                            <br>$\int_{0}^{1} f(x) \, dx$                                             |                                  `for(float x = 0.0; x <= 1.0; x += dx) {integral += f(x) * dx; }`<br><br><font color="#7f7f7f">Sum accumulation (Area under curve) inside a loop.</font>                                  |                      |                                                |
|                                                   <font color="#00b050">Differential<br>(Delta)</font><br>[[#Delta Δ]]                                                    |                                                  $\Delta x$<br>$dx$                                                  |                                                                       <font color="#7f7f7f">A tiny change or step (e.g., `float dx = 0.01;`).</font>                                                                       |                      |                                                |
|                                                          <br><font color="#00b050">Piecewise function</font><br>                                                          |                          <br>$f(x) = \begin{cases} a, & x < 0 \\ b, & x \ge 0 \end{cases}$                           |                                                                                               <br>`mix(a, b, step(0.0, x))`                                                                                                |                      |                                                |
...
|                                              <font color="#00b050">Absolute value<br>Sign of a number (-1, 0, 1)</font><br>                                               |                                               \|x\|<br>$\text{sgn}(x)$                                               |                                                                                                   `abs(x)`<br>`sign(x)`                                                                                                    | $<br>$\text{sgn}(x)$ | `abs(x)`<br>`sign(x)`                          |
